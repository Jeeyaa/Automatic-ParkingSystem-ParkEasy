...
<div id="about" class="container-fluid">
  <div class="row">
    <div class="col-sm-14">
      ...
      <br>
	  <img src="diagram.png" width="90%"> </img>
...
$sqlq="insert into user_details(username, password, email, license_plate, first_name, last_name) values ('$usern','$passwd','$emailid','$license', '$firstname','$lastname')" ;
